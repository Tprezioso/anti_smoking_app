...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [self applicationSignificantTimeChange:[UIApplication sharedApplication]];
...
{
    // The directory the application uses to store the Core Data store file. This code uses a directory named "self.edu.tom.CleanUrLungs" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"CleanUrLungs" withExtension:@"momd"];
